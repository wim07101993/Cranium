...
namespace Cranium.WPF.Services.Mongo
{
        ...
        where T : IWithId
    {
        ...
        /// <summary>
        /// Replaces a <see cref="T"/> in the database. The <see cref="T"/> to replace is selected by comparing the
        ...
        /// <param name="propertyToRemoveItemFrom">Property to remove the <see cref="TValue"/> from</param>
        ...
        Task RemoveItemFromList<TValue>(ObjectId id, Expression<Func<T, IEnumerable<TValue>>> propertyToRemoveItemFrom,
            TValue itemToRemove);
    }
}
