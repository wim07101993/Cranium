...
namespace Cranium.WPF.Game
{
    public class GameService : AMongoModelService<Game>, IGameService
    {
        ...
        public async Task<Game> CreateAsync(TimeSpan gameTime, IReadOnlyList<Player.Player> players)
        {
        ...
        public async Task<Game> CreateAsync(int cycleCount, IReadOnlyList<Player.Player> players)
        {
            ...
            var board = new GameBoard.GameBoard(tiles);
        ...
        private static IEnumerable<Tile.Tile> CreateTiles(int cycleCount, IList<Category> categories)
        {
