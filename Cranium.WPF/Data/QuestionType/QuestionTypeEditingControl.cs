...
namespace Cranium.WPF.Data.QuestionType
{
    public class QuestionTypeEditingControl : AModelEditingControl<QuestionType>
    {
        ...
        public static readonly DependencyProperty CategoriesProperty = DependencyProperty.Register(
            nameof(Categories),
            typeof(IList<Category.Category>),
            typeof(QuestionTypeEditingControl),
            new PropertyMetadata(default(IList<Category.Category>), OnCategoriesChanged));
        ...
        public IList<Category.Category> Categories
        {
            get => (IList<Category.Category>) GetValue(CategoriesProperty);
        ...
        private void OnComboboxSelectedItemChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Model.Category = _comboBox.SelectedItem as Category.Category;
